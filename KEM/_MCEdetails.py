...
output_file = "_MCE_output.txt"

# Initialize Classic McEliece Key Encapsulation Mechanism (KEM)
kem = oqs.KeyEncapsulation("Classic-McEliece-348864f")  # Example Classic McEliece variant
...
with open(output_file, "w") as file:
    file.write("=== Classic McEliece Key Encapsulation ===\n")
